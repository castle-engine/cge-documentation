...
starting like PLUG\_. At one point we had a code that didn't look at any
special function names, instead you defined plug name in the separate field,
however this was unclean --- you had to split your algorithm into many parts,
often 1/2-liners, especially the fact that you had to declare uniform variables
in a separate effect part seemed bad. Detecting PLUG\_ function names it easy
and works nicely.
