...
%% TODO: mark \cite{x3d:shaders} and shortly describe here
...
\begin{figure}[H]
  \centering
  \includegraphics[width=3in]{fancy_light_spot_shape-cropped}
...
Another example is \emph{water}.
Water is very easy to implement with the help of our effects,
...
You would first have to prepare shader code to calculate all
