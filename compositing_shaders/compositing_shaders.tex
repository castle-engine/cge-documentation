...
%Michalis Kamburelis\thanks{e-mail: michalis.kambi@gmail.com}\\Institute of Computer Science\\University of Wroc{\l}aw, Poland}
...
on \myhref{http://vrmlengine.sourceforge.net/compositing\_shaders.php}{http://vrmlengine.sourceforge.net/compositing_shaders.php}.
...
making it clear where the alternative versions differ and what do they have
in common.
...
The Japanese shrine model, used for an eye-candy screenshots
at the beginning of this paper, comes from
\myhref{http://opengameart.org/content/shrine-shinto-japan}{http://opengameart.org/content/shrine-shinto-japan}.
