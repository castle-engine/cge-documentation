...
Our extensions integrate shader effects naturally with X3D
%groups,
shapes, light sources and textures.
...
A different approach is presented by the Sh language (\URL{http://libsh.org/}).
...
SFString [] \codeem{language} ""
  # Shading language: "GLSL", "CG",
  # "HLSL". This effect will be used
...
\URL{http://opengameart.org/content/shrine-shinto-japan}.
