...
Special plug names \$declare-variables\$, \$declare-forward-procedures\$,
\$declare-procedures\$ are used to designate a place where functions are placed.
...
TODO: test such ComposedShader, should work but not tested yet.
