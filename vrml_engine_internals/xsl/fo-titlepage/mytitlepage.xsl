...
<xsl:template name="book.titlepage.before.recto"><fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format">
      <fo:block font-family="DejaVuSans" font-weight="bold" font-size="24.8832pt" text-align="center" space-before="18.6624pt">
        <fo:block keep-with-next.within-column="always" hyphenate="false">Przetwarzanie i renderowanie modeli w formacie VRML</fo:block>
      </fo:block>

      <fo:block font-family="DejaVuSans" font-weight="bold" font-size="17.28pt" text-align="center" space-before="10.8pt" keep-with-next.within-column="always">
        <fo:block>Michalis Kamburelis</fo:block>
      </fo:block>

      <fo:block font-family="DejaVuSans" font-weight="normal" font-size="17.28pt" text-align="center" space-before="80.8pt" keep-with-next.within-column="always">
        <fo:block>Praca magisterska pod kierunkiem
          <fo:block><xsl:text/></fo:block>
          <fo:inline font-weight="bold">dr Andrzeja Łukaszewskiego</fo:inline></fo:block>
      </fo:block>

      <fo:block font-family="DejaVuSans" font-weight="normal" font-size="17.28pt" text-align="center" space-before="200.8pt" keep-with-next.within-column="always">
        Instytut Informatyki
        <fo:block><xsl:text/></fo:block>
        Uniwersytet Wrocławski
      </fo:block>

      <fo:block font-family="DejaVuSans" font-weight="normal" font-size="17.28pt" text-align="center" space-before="40.8pt" keep-with-next.within-column="always">
        <fo:block>Wrocław, Wrzesień 2006
        <fo:block><xsl:text/></fo:block>
        (z aktualizacjami później)
        </fo:block>
      </fo:block>
